***Settings***
Documentation       Aqui esta as Keywords helpers

***Variables***
${BTN_COMEÇAR}              COMEÇAR    
${HAMBURGUER}               xpath=//android.widget.ImageButton[@content-desc="Open navigation drawer"]
${NAV_TELA_LATERAL}         id=io.qaninja.android.twp:id/rvNavigation     


***Keywords***

Get Started
    Wait Until Page Contains            ${BTN_COMEÇAR}        
    Click Text                          ${BTN_COMEÇAR}

Open Nav 
    Wait Until Element Is Visible      ${HAMBURGUER}       
    Click Element                      ${HAMBURGUER} 
    Wait Until Element Is Visible      ${NAV_TELA_LATERAL} 
...
Go To Login Form
    ...
    Click Text      LOGIN
    Wait Until Page Contains        Fala QA, vamos testar 
